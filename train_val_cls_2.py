...
def main():
    ...
    parser.add_argument('--save_folder_chenzhixing_2', '-s', help='Path to folder for saving check points and summary', required=True)
    ...
    root_folder = os.path.join(args.save_folder_chenzhixing_2, '%s_%s_%s' % (args.model, args.setting, args.train_name))
